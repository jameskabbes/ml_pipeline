...
class Input_File( ML_Input_File.Input_File ):
    ...
    def __init__( self, Input_Files_inst, **supplemental_kwargs ):
        ...
        joined_kwargs = ps.replace_default_kwargs( Input_File.OVERRIDE_KWARGS, **supplemental_kwargs )
        ML_Input_File.Input_File.__init__( self, Input_Files_inst, **joined_kwargs  )
